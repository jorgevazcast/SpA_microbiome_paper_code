...
load(paste0(path_dir, "/1_infiles/Treatment_response/physeq.TreatRes.qmp.motus.RData"))
physeq_QMP <- physeq.TreatRes.qmp.motus
...
ggsave("AllPCoAs.pdf", AllPCoAs, width=30, height=15)
AllPCoAs
...
if(any(bray.table.ADONIS$BH.adj.p.value < FDR_pval) == F ){
