...
rar.file <- as.character(argscomd[1]) # rar.file <- "/home/luna.kuleuven.be/u0141268/Postdoc_Raes/Projects/giant_cohort_spa/1_infiles/Treatment_response/physeq.TreatRes.qmp.gmm.RData"
#above10000.file <- as.character(argscomd[3])
#clr.file <- as.character(argscomd[4])
Variable = as.character(argscomd[2]) ## Variable = "Response" # Histological_Inflammation Histology Variable = "Disease"
...
# rar.file <- "/home/luna.kuleuven.be/u0141268/Postdoc_Raes/Projects/giant_cohort_spa/1_infiles/Treatment_response/physeq.TreatRes.qmp.gmm.RData"
