...
EE <- "ee2"
phyloseq_in <- readRDS(file=paste0(working_dir,"/1_infiles/mice_PacBio_data/phyloseq_20k_",EE,"/physeq_Species_decontam_Qfemto.rds"))
...
load(paste0(sigfiles,"/all_samples_species/WT_diff/WT_w12.RData"))
...
pdf("Heatmap.pdf", width = 13 , height = 8)
...
pImportance	
ggsave( file = "Taxa_correlation.pdf" , pImportance, width = 9, height = 9 )	
